...
<div className="event">
    ...
    <div className="sheet">
        ...
        <h1 style={{color:'white',fontSize:'9vw',fontFamily: 'Chakra Petch'}}>Events</h1>
    {content.map((element,ctx) => (
        ...
        <a href="https://www.figma.com/file/3RdcXNnmwRiOXmzsZDb8RW/ISTE-GECT?node-id=0%3A1&t=sKz1JXpa45GG4ftX-0" className='learnmore'>LEARN MORE</a></div>
            </div>
      ))}
   </div>
    </div>
